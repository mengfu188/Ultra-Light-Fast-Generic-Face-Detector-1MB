...
class HelmetDataset:
    ...
    def __init__(self, file, transform=None, target_transform=None, filter_size=0, **kwargs):
        ...
        self.classes = self.class_names = kwargs.get('classes') or ('BACKGROUND', 'head', 'helmet')
        # 要使用全部数据还是部分数据[0, 1]
...
if __name__ == '__main__':
    ...
    dataset = HelmetDataset('/home/cmf/datasets/brainwash/data_list_brainwash_train.pkl')
